...
public interface IContentService
{
    ...
    Task<Response<ContentItemDTO>> GetFeaturedPublished();
    Task<Response<ContentItemDTO>> GetPublishedBySlug(string slug);
    Task<Response<int>> RecordJournalView(Guid id);
